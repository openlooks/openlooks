...
export default function PaperPage() {
  ...
  return (
    <>
      <DocHeader title="Paper" description="Renders white or dark background depending on color scheme" />
      <Container size="sm">
        <Title order={2}>Usage</Title>
        <Text mb="xl">
          Paper component renders white (or theme.colors.dark[7] for dark theme) background with shadow, border-radius
          and padding from theme.
        </Text>
        <Configurator>
